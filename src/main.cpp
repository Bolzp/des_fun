...
int main()
{
  ...
  std::cout << (des_encryptor.decrypt(0x492967C4E99F8523, 0xAABB09182736CCDD) == 0x1200000000000000) << std::endl;
  //std::cout << (des_encryptor.process(0x0123456789ABCDEF, 0x133457799BBCDFF1) == 0x85E813540F0AB405) << std::endl;
  std::cout << (des_encryptor.decrypt(0x85E813540F0AB405, 0x133457799BBCDFF1) == 0x0123456789ABCDEF) << std::endl;
  //std::cout << (des_encryptor.process(0x23456ABCD132536a, 0xAABB09182736CCDD) == 0xC2490D5EC178E1D3) << std::endl;
  std::cout << (des_encryptor.decrypt(0xC2490D5EC178E1D3, 0xAABB09182736CCDD) == 0x23456ABCD132536a) << std::endl;
